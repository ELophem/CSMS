...
class ChargePoint(cp2):
    ...
    async def read_config_and_send_values(self):
        try:
            config_path = os.path.abspath('config_CP_2.json')
...
async def main():
    ...
    config_path = os.path.abspath('config_CP_2.json')  # Ensure this path is correct
    ...
    async with websockets.connect(
        ...
        await asyncio.gather(cp2.start(), cp2.send_boot_notification(boot_data))
